...
//                                 <InputText autoComplete id="name" name="name" value={formik.values.name} onChange={formik.handleChange} autoFocus className={classNames({ 'p-invalid': isFormFieldValid('name') })} />
...
//                         <div className="field">
//                             <span className="p-float-label">
//                                 <InputText autoComplete id="firstName" name="firstName" value={formik.values.firstName} onChange={formik.handleChange} autoFocus className={classNames({ 'p-invalid': isFormFieldValid('firstName') })} />
...
//                         <div className="field">
//                             <span className="p-float-label">
//                                 <InputText autoComplete id="middleName" name="middleName" value={formik.values.middleName} onChange={formik.handleChange} autoFocus className={classNames({ 'p-invalid': isFormFieldValid('middleName') })} />
...
//                         <div className="field">
//                             <span className="p-float-label">
//                                 <InputText autoComplete id="lastName" name="lastName" value={formik.values.name} onChange={formik.handleChange} autoFocus className={classNames({ 'p-invalid': isFormFieldValid('lastName') })} />
...
//                         <div className="field">
//                             <span className="p-float-label">
//                                 <InputText autoComplete  id="phone" name="phone" value={formik.values.phone} onChange={formik.handleChange} autoFocus className={classNames({ 'p-invalid': isFormFieldValid('phone') })} />
...
//                                 <InputText autoComplete id="email" name="email" value={formik.values.email} onChange={formik.handleChange} className={classNames({ 'p-invalid': isFormFieldValid('email') })} />
...
//                         <div className="field">
//                             <span className="p-float-label">
//                                 <Password autoComplete id="password" name="password" value={formik.values.password} onChange={formik.handleChange} toggleMask
...
//                         <div className="field">
//                             <span className="p-float-label">
//                                 <Calendar autoComplete id="date" name="date" value={formik.values.date} onChange={formik.handleChange} dateFormat="dd/mm/yy" mask="99/99/9999" showIcon />
//                                 <label htmlFor="date">Birthday</label>
//                             </span>
//                         </div>
//                         <div className="field">
//                             <span className="p-float-label">
//                                 <Dropdown autoComplete id="country" name="country" value={formik.values.country} onChange={formik.handleChange} options={countries} optionLabel="name" />
//                                 <label htmlFor="country">Country</label>
//                             </span>
//                         </div>
//                         <div className="field-checkbox">
//                             <Checkbox autoComplete inputId="accept" name="accept" checked={formik.values.accept} onChange={formik.handleChange} className={classNames({ 'p-invalid': isFormFieldValid('accept') })} />
...
/*
Adama (also called Nazareth or Nazret)
Addis Ababa
...
const selected=props.selected
  const formik = useFormik({
    initialValues: {
      firstName: selected._id,
      middleName: selected._id,
      lastName:selected._id,
      phone: selected.personalInfo.address.subcity,
      city: null,
      subcity: "no",
      wereda: "04",
      kebele: "5",
      ...
      username: 'selected.accountInfo.username',
      name: selected.id,
      email: selected.personalInfo.email,
      accept: false,
    },
    validate: (data) => {
      let errors = {};
