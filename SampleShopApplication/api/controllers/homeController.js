...
var sellerCode = "SB1733",
  successUrlReturn = "http://localhost:5001/complete", //"YOUR_SUCCESS_URL",
  ipnUrlReturn = "http://localhost:5001/complete", //"YOUR_IPN_URL",
  cancelUrlReturn = "http://localhost:3000", //"YOUR_CANCEL_URL",
  failureUrlReturn = "http://localhost:3001", //"YOUR_FAILURE_URL",
  pdtToken = "v7bO9ENKVquiFz",
  useSandbox = true,
  currency = "USD";

exports.CheckoutExpress = function (req, res) {
  var merchantOrderId = req.body.ItemId; //"YOUR_UNIQUE_ID_FOR_THIS_ORDER";  //can also be set null
  var expiresAfter = 5; //"NUMBER_OF_MINUTES_BEFORE_THE_ORDER_EXPIRES"; //setting null means it never expires
